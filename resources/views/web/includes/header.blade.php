<header class="header-area2 style-2 two">
		<div class="header-logo">
			<a href="{{url('/')}}"><img alt="image" class="img-fluid" src="{{asset('assets/home/king-blanco.png')}}" width="200px"></a>
		</div>
		<div class="main-menu">
			<div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
				<div class="mobile-logo-wrap">
					<a href="{{url('/')}}}"><img alt="image" src="{{asset('assets/home/king-blanco.png')}}"></a>
				</div>
			</div>
			<ul class="menu-list">
				<li class="active">
					<a href="{{url('/')}}" >Inicio</a><i class="bi bi-plus -icon"></i>
				</li>
				<li><a href="{{url('/nosotros')}}">Nosotros</a></li>
				
				<li class="menu-item-has-children">
					<a href="#" class="drop-down">Productos</a><i class="bi bi-plus dropdown-icon"></i>
					<ul class="sub-menu">
						<li>
							...
							<ul class="sub-menu">
								<li><a href="https://franquicias.kingtech.pe/" target="_blank">Tinbet</a></li>
								<li><a href="https://franquicias.kingtech.pe/" target="_blank">Betgana</a></li>
						...
						<li>
							...
							<i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
							<ul class="sub-menu">
								<li><a href="https://franquicias.kingtech.pe/">BetganaRace</a></li>
				...
				<li class="menu-item-has-children">
					<a href="#" class="drop-down">Casa de Apuestas</a><i class="bi bi-plus dropdown-icon"></i>
					<ul class="sub-menu">
				...
				<li class="menu-item-has-children">
					<a href="#" class="drop-down">Noticias</a><i class="bi bi-plus dropdown-icon"></i>
					<ul class="sub-menu">
				...
				<li class="menu-item-has-children">
					<a href="{{url('/blog')}}" class="drop-down">Blog</a><i class="bi bi-plus dropdown-icon"></i>
					<ul class="sub-menu">
				...
				<form class="mobile-menu-form">
					<div class="hotline pt-30">
						...
						<div class="hotline-info">
							...
							<h6><a href="tel:51913069000">+51 913 069 000</a></h6>
						</div>
					</div>
					<div class="email pt-20 d-flex align-items-center">
						...
						<div class="email-info">
							<span>E-mail</span>
							<h6><a href="mailto:info@kingtech.pe"><span class="__cf_email__">info@kingtech.pe</span></a></h6>
						</div>
					</div>
				</form>
				<div class="header-btn5">
					<a class="primary-btn3" href="https://wa.me/51913069000" target="_blank">WhatsApp</a>
				</div>
			</div>
		</div>
		<div class="nav-right d-flex jsutify-content-end align-items-center">
			<div class="header-contact d-xl-block d-none">
				<span><img src="assets/img/home-6/phone.svg" alt>Atención Telefónica:</span>
				<h6><a href="Tel:51913069000">+51 913 069 000</a></h6>
			</div>
			<div class="header-btn d-sm-flex d-none">
				<a href="https://wa.me/51913069000" target="_blank">Escribir vía WhatsApp</a>
			</div>
