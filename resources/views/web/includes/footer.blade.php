						...
						<div class="col-lg-12">
							<div class="footer-top-content">
								<div class="footer-logo">
									<a href="index.html"><img class="img-fluid" src="{{asset('assets/home/king-blanco.png')}}" width="280px"></a>
								</div>
					...
					<div class="col-lg-4 col-sm-6 d-flex">
						<div class="footer-widget">
							<div class="footer-contact mb-40">
								...
								<a href="https://www.google.com/maps/place/Av.+Gral.+Antonio+Alvarez+de+Arenales+2523,+Lince+15046/@-12.089371,-77.0348,17z/data=!4m6!3m5!1s0x9105c85e3889d159:0x8ac4fa1a74e7c08a!8m2!3d-12.0893706!4d-77.0347996!16s%2Fg%2F11ts_wfyv0?hl=es-419" target="_blank">Av. Gral. antonio alvarez de arenales 2523, lince 15046</a>
							</div>
							<div class="footer-contact mb-40">
								<h4>
								...
								<a href="mailto:contacto@kingtech.pe" >contacto@kingtech.pe</span></a><br>
						...
						<div class="footer-widget">
							...
							<div class="menu-container">
								<ul>
									...
									<li><a href="{{url('/contacto')}}">Solicitud Fanquicia</a></li>
									<li><a href="https://wa.me/51913069000" target="_blank">Solicitud Agente</a></li>
						...
						<div class="footer-widget">
							...
							<div class="menu-container">
								<ul>
									...
									<li><a href="{{url('/casa-de-apuestas')}}">Casa de Apuestas</a></li>
						...
						<div class="footer-widget">
							...
							<div class="menu-container">
								<ul>
									...
									<li><a href="https://wa.me/51913069000" target="_blank">Soporte</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="footer-btn-content">
								<div class="copyright-area">
									<p>©Copyright 2023 <a href="#">Kingtech</a> </p>
								</div>
								<div class="footer-social">
									<ul>
										<li><a href="https://www.facebook.com/KingtechCorporation" target="_blank"><i class="bx bxl-facebook"></i></a></li>
										<li><a href="https://twitter.com/" target="_blank"><i class="bx bxl-twitter"></i></a></li>
										<li><a href="https://www.linkedin.com/company/kingtechperu/" target="_blank"><i class="bx bxl-pinterest-alt"></i></a></li>
										<li><a href="https://www.instagram.com/kingtechperu/" target="_blank"><i class="bx bxl-instagram"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
